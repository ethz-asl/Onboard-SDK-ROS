...
Camera0
{
  CalibrationFile ; 		Camera-Calibration file for intrinsics
	qCM_x  0.00477807148027                               X-entry of IMU to Camera quaterion (Hamilton)
  qCM_y  0.00044464256768                               Y-entry of IMU to Camera quaterion (Hamilton)
  qCM_z  -0.00184480026571                               Z-entry of IMU to Camera quaterion (Hamilton)
  qCM_w  -0.999986784432                               W-entry of IMU to Camera quaterion (Hamilton)
  MrMC_x 0.00361442399179                               X-entry of IMU to Camera vector (expressed in IMU CF) [m]
  MrMC_y 0.00370096828691                               Y-entry of IMU to Camera vector (expressed in IMU CF) [m]
  MrMC_z 0.00727946480411                               Z-entry of IMU to Camera vector (expressed in IMU CF) [m]
}
...
Prediction
{
    PredictionNoise
    {
        ...
        vel_0 5e-4; 4e-6						X-covariance parameter of velocity prediction [m^2/s^3]
        vel_1 5e-4;								Y-covariance parameter of velocity prediction [m^2/s^3]
		vel_2 5e-4;								Z-covariance parameter of velocity prediction [m^2/s^3]
        ...
        att_0 7.6e-5; 7.6e-7					X-Covariance parameter of attitude prediction [rad^2/s]
        att_1 7.6e-5;							Y-Covariance parameter of attitude prediction [rad^2/s]
        att_2 7.6e-5;							Z-Covariance parameter of attitude prediction [rad^2/s]
